...
export default function ServiceForm({
  ...
  const onSubmit = async (values: ServiceFormValues) => {
    try {
      const thumbnail =
        images.length > 0 ? images[primaryImageIndex] : values.thumbnail;
  ...
  const removeImage = (index: number) => {
    ...
    if (newImages.length > 0) {
      form.setValue("thumbnail", newImages[primaryImageIndex] || newImages[0]);
    } else {
      ...
      <Card className="bg-transparent border-border-variant">
        ...
        <CardContent className="space-y-4">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input {...field} placeholder="url-servisa" />
                </FormControl>
                <FormDescription>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input {...field} placeholder="Краткое описание услуги" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  Если не задано, будет использовано название услуги
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  Если не задано, будет использовано краткое описание
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input {...field} placeholder="Введите цену услуги" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input {...field} placeholder="Введите длительность услуги" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Что включает услуга</FormLabel>
                <FormControl>
                  <TagsInput
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>В стоимость входит</FormLabel>
                <FormControl>
                  <TagsInput
                    placeholder="Добавьте пункт и нажмите Enter"
                    value={field.value || []}
          ...
          render={({ field }) => (
            <FormItem className="flex flex-row items-center space-x-3 space-y-0">
              <div className="space-y-1 leading-none w-full">
                ...
                <FormDescription>
                  Если отмечено, услуга будет видна пользователям
                </FormDescription>
              </div>
              <FormControl>
                <Switch
